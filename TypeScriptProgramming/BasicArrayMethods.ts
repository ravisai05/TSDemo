...
//indexOf method is used to return the first index at which a given element can be found in the array, or -1 if it is not present. It does not modify the original array.
let indexOfNum=nums.indexOf(22);
let indexOfFruit=fruit.indexOf("Dragonfruit");
console.log(indexOfNum);    
console.log(indexOfFruit);
//includes method is used to determine whether an array includes a certain element, returning true or false as appropriate. It does not modify the original array.
let hasNum=nums.includes(23);
let hasFruit=fruit.includes("Cantaloupe");
console.log(hasNum);    
console.log(hasFruit);

//toString method is used to convert an array to a string and returns the resulting string. It does not modify the original array.
